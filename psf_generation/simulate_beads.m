...
figure, imshow3D(lr_low_density_norm, []);
%% write 3d image
write_tiff(lr_low_density_norm, 'low_density_128_128_30.tif')
write_tiff(low_density_img_norm, 'low_density_512_512_60.tif')
